# Placeholder. install.sh renders the real layout from nixos/install/disko.nix
# with the disk you pick at install time, and postinstall.sh syncs it back over
# this file. The device path below is not a real disk.
{
  disko.devices = {
    disk.main = {
      type = "disk";
